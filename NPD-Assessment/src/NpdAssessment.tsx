...
const formFieldsConfig = [
  ...
  { id: 'group', label: 'Group', type: 'text', required: true },
  { id: 'business', label: 'Business', type: 'text', required: true },
  { id: 'assessmentLead', label: 'Assessment Lead', type: 'text', required: true },
  { id: 'assessmentID', label: 'Assessment ID', type: 'text', required: true },
  { id: 'maturity', label: 'Maturity', type: 'text', required: true },
  { id: 'assessmentDate', label: 'Assessment Date', type: 'date', required: true },
  { id: 'status', label: 'Status', type: 'text', required: true },
  { id: 'actions', label: 'Actions', type: 'text', required: true },
  { id: 'assessmentType', label: 'Assessment Type', type: 'text', required: true },
];
